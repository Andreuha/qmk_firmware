...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,          KC_X,    KC_C,    KC_V,    KC_B,    KC_PSCR, KC_BSLS, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_T(KC_ENT) , \
      KC_LCTL, LCTL(KC_LSFT), KC_LGUI, KC_LALT, LOWER,   NAVSPC,  KC_ENT,  NAVDEL,  NAVSPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
