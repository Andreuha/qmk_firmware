/**********
This is the default_md keymap with the addition of a "navigation" layer accessed via the spacebar.
Nav group keys for using Excel and taking screenshots are
**********/
...
#define NAVSPC LT( 9, KC_SPC)
#define H_CAD LALT(LCTL(KC_DEL))
#define H_UNDO LCTL(KC_Z)
#define H_CUT LCTL(KC_X)
#define H_COPY LCTL(KC_C)
#define H_PASTE LCTL(KC_V)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   NAVSPC,                             KC_RALT, MO(1),   KC_RGUI,          KC_RCTL  \
    ),
    [1] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  \
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   L_EDG_I, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, KC_UP,   _______, _______, U_T_AGCR,\
        H_CAD,   L_PTP,   L_BRD,   L_PTN,   L_EDG_D, _______, KC_INS,  KC_HOME, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT,          _______, \
        _______, L_T_MD,  L_T_ONF, _______, L_EDG_M, MD_BOOT, TG_NKRO, KC_END,  KC_PGDN, KC_VOLD, KC_VOLU,                   _______, \
        _______, _______, L_T_PTD,                   DBG_FAC,                            KC_MUTE, _______, KC_APP,           _______  \
    ),
    [9] = LAYOUT(
        ...
        KC_DEL,  KC_F5,   xxxxxxx, KC_LSFT, KC_LCTL, xxxxxxx, xxxxxxx, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,          _______, \
        _______, H_UNDO,  H_CUT,   H_COPY,  H_PASTE, xxxxxxx, xxxxxxx, xxxxxxx, _______, _______, _______,                   _______, \
