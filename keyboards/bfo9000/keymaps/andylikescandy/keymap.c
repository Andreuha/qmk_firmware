...
[_BASE] = LAYOUT( \
    CTLALTSFT,  KC_F1,    KC_F2,    KC_F3,   KC_F4,    KC_F5,   KC_F6,    KC_F7,      KC_F8,                      KC_NUMLOCK,   KC_KP_ASTERISK, KC_KP_SLASH,    KC_F9,   KC_F10,   KC_F11,    KC_F12,   KC_MINS,        KC_EQL,     \
    KC_GRV,     KC_1,     KC_2,     KC_3,    KC_4,     KC_5,    KC_CAPS,  KC_PSCREEN, KC_PAUSE,                   KC_INSERT,    KC_PPLS,        KC_PMNS,        KC_6,    KC_7,     KC_8,      KC_9,     KC_0,           KC_BSLASH,   \
    KC_TAB,     KC_Q,     KC_W,     KC_F,    KC_P,     KC_G,    CTL_T(KC_ENT), KC_LBRC, KC_RBRC,                  KC_P7,        KC_P8,          KC_P9,          KC_J,    KC_L,     KC_U,      KC_Y,     KC_SCLN,        KC_BSPC,         \
    KC_ESC,     KC_A,     KC_R,     KC_S,    KC_T,     KC_D,    KC_HOME,  KC_END,     KC_PGUP,                    KC_P4,        KC_P5,          KC_P6,          KC_H,    KC_N,     KC_E,      KC_I,     KC_O,           KC_QUOT,          \
    KC_LSFT,    KC_Z,     KC_X,     KC_C,    KC_V,     KC_B,    KC_DEL,   KC_UP,      KC_PGDN,                    KC_P1,        KC_P2,          KC_P3,          KC_K,    KC_M,     KC_COMM,   KC_DOT,   KC_SLSH,        SFT_T(KC_ENT),      \
    KC_LCTL,    CTRLSFT,  KC_LGUI,  KC_LALT, RSESPC,   NAVSPC,  KC_LEFT,  KC_DOWN,    KC_RGHT,                    KC_P0,        KC_PDOT,        SFT_T(KC_ENT),  NAVSPC,  RSESPC,   KC_RALT,   KC_RGUI,  KC_APPLICATION, KC_RCTL       \
),
[_QWERTY] = LAYOUT( \
    CTLALTSFT,  KC_F1,    KC_F2,    KC_F3,   KC_F4,    KC_F5,         KC_F6,    KC_F7,      KC_F8,                      KC_NUMLOCK,   KC_KP_ASTERISK, KC_KP_SLASH,    KC_F9,   KC_F10,   KC_F11,    KC_F12,   KC_MINS,        KC_EQL,     \
    KC_GRV,     KC_1,     KC_2,     KC_3,    KC_4,     KC_5,          KC_CAPS,  KC_PSCREEN, KC_PAUSE,                   KC_INSERT,    KC_PPLS,        KC_PMNS,        KC_6,    KC_7,     KC_8,      KC_9,     KC_0,           KC_BSLASH,   \
    KC_TAB,     KC_Q,     KC_W,     KC_E,    KC_R,     KC_T,          CTL_T(KC_ENT), KC_LBRC,  KC_RBRC,                 KC_P7,        KC_P8,          KC_P9,          KC_Y,    KC_U,     KC_I,      KC_O,     KC_P,           KC_BSPC,         \
    KC_ESC,     KC_A,     KC_S,     KC_D,    KC_F,     KC_G,          KC_HOME,  KC_END,     KC_PGUP,                    KC_P4,        KC_P5,          KC_P6,          KC_H,    KC_J,     KC_K,      KC_L,     KC_SCLN,        KC_QUOT,          \
    KC_LSFT,    KC_Z,     KC_X,     KC_C,    KC_V,     KC_B,          KC_DEL,   KC_UP,      KC_PGDN,                    KC_P1,        KC_P2,          KC_P3,          KC_N,    KC_M,     KC_COMM,   KC_DOT,   KC_SLSH,        SFT_T(KC_ENT),      \
    KC_LCTL,    CTRLSFT,  KC_LGUI,  KC_LALT, RSESPC,   NAVSPC,        KC_LEFT,  KC_DOWN,    KC_RGHT,                    KC_P0,        KC_PDOT,        SFT_T(KC_ENT),  NAVSPC,  RSESPC,   KC_RALT,   KC_RGUI,  KC_APPLICATION, KC_RCTL       \
),
[_RAISE] = LAYOUT( \
