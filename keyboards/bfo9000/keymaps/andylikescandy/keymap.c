...
[_BASE] = LAYOUT( \
    ...
    KC_GRV,     KC_1,     KC_2,     KC_3,    KC_4,     KC_5,    KC_CAPS,  KC_PSCREEN, KC_PAUSE,                   KC_INSERT,    KC_PPLS,        KC_PMNS,        KC_6,    KC_7,     KC_8,      KC_9,     KC_0,           KC_MINS,   \
    KC_TAB,     KC_Q,     KC_W,     KC_F,    KC_P,     KC_G,    KC_LBRC,  KC_RBRC,    CTL_T(KC_ENT),              KC_P7,        KC_P8,          KC_P9,          KC_J,    KC_L,     KC_U,      KC_Y,     KC_SCLN,        KC_BSPC,         \
...
[_QWERTY] = LAYOUT( \
    CTLALTSFT,  KC_F1,    KC_F2,    KC_F3,   KC_F4,    KC_F5,         KC_F6,    KC_F7,      KC_F8,                      KC_NUMLOCK,   KC_KP_ASTERISK, KC_KP_SLASH,    KC_F9,   KC_F10,   KC_F11,    KC_F12,   KC_MINS,        KC_EQL,     \
    KC_GRV,     KC_1,     KC_2,     KC_3,    KC_4,     KC_5,          KC_CAPS,  KC_PSCREEN, KC_PAUSE,                   KC_INSERT,    KC_PPLS,        KC_PMNS,        KC_6,    KC_7,     KC_8,      KC_9,     KC_0,           KC_MINS,   \
    KC_TAB,     KC_Q,     KC_W,     KC_E,    KC_R,     KC_T,          KC_LBRC,  KC_RBRC,    CTL_T(KC_ENT),              KC_P7,        KC_P8,          KC_P9,          KC_Y,    KC_U,     KC_I,      KC_O,     KC_P,           KC_BSPC,         \
