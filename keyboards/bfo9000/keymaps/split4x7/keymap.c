...
[_COLEMAK] = LAYOUT( \
    ...
    KC_LCTL,    CTRLSFT,  KC_LGUI,  KC_LALT,  RSESPC,   NAVSPC,  CTLALTSFT,   ooooooo, ooooooo,              SFT_T(KC_ENT), NAVSPC,  RSESPC,  KC_LEFT,   KC_DOWN,   KC_UP,    CTL_T(KC_RIGHT), ooooooo,  ooooooo,  \
...
[_NAVIGATION] = LAYOUT( \
    ...
    KC_DEL,     _______,  XXXXXXX,  KC_LSFT,  KC_LCTL,  XXXXXXX,  XXXXXXX,  ooooooo,  ooooooo,            XXXXXXX,  XXXXXXX,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, _______, ooooooo, ooooooo,        \
    _______,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  ooooooo,  ooooooo,            XXXXXXX,  XXXXXXX,  KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   _______, ooooooo, ooooooo,       \
    _______,    _______,  _______,  _______,  _______,  _______,  _______,  ooooooo,  ooooooo,            _______,  _______,  _______,  _______,  _______,  _______,  _______, ooooooo, ooooooo,        \
    ooooooo,    ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,            ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo, ooooooo, ooooooo,        \
    ooooooo,    ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,            ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo,  ooooooo, ooooooo, ooooooo      \
)
